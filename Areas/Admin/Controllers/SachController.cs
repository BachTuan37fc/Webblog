        ...
        public IActionResult Index()
{
    var sachList = _context.Sachs
        ...
        {
            Sachs = s,
            Total = _context.MaCaBiets
                .Count(mcb => mcb.ID_Sach == s.ID_Sach),
    ...
    return View(sachList);
        ...
        public IActionResult Create()
        {
            ...
            // });
              var mnList = _context.NhaXuatBans
    .Select(nxb => new SelectListItem
    {
        Text = nxb.TenNXB,
        Value = nxb.ID_NXB.ToString()
    }).ToList();
...
ViewBag.mnList = mnList;
            ...
            var sList = _context.DanhMucs
    .Select(dm => new SelectListItem
    {
        Text = dm.TenDM,
        Value = dm.ID_DM.ToString()
    }).ToList();
